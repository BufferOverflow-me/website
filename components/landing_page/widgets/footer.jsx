...
function footer() {
  return (
    <div className='dark:bg-black bg-[#222222]'>
      <footer className={styles.footer}>
        <div className={styles.Container}>
          <div className={styles.leftdiv}>
            <h1 className=" text-4xl mb-5 font-bold">BufferOverflow</h1>
            <p className={"font-thin text-gray-400"}>Your applications, wordpress themes, designs and many more are just a click away!</p>
            <div>
              <ul>
                <li>
